...
\titulo{El origen del mono con tres cabezas}

% Para el resumen, escribe aqui el título en inglés
\tituloIN{Three headed monkey's origin}

% Aquí va el nombre de tu programa de posgrado
\posgrado{Scum Department}
\posgradoUP{CIENCIAS DE LA PIRATER\'IA}
...
\fechaexamen{Septiembre, 2014}\fechaexamenIN{September, 2014}
...
\palabrasclave{stuff 1, stuff 2, stuff 3, and so on.}
...
\keywords{stuff 1, stuff 2, stuff 3, and so on.}
