...
\titulo{Medici\'on de los efectos del grog en los estudiantes de posgrado por medio de c\'omputo vestible}

% Para el resumen, escribe aqui el título en inglés
\tituloIN{Grog's effects measurement on posgraduate students trough wearable computing}
...
\fechaexamen{Agosto, 2015}\fechaexamenIN{August, 2015}

% Fecha (dia, mes y año) de la defensa de tesis para la hoja de firmas
\fechaexamencompleta{Agosto, 2015}
...
\director{Dr. Gordon Freeman}
%\director{Dr. Asesor 2}

% Nombres de los sinodales, en el orden que aparecerán en la
% página de firmas
%%NO UTILIZAR ABREVIATURAS
\sinodal{Dr. Gordon Freeman}
%\sinodal{}
%\sinodal{Dra. Sharon Zinah Herzka Llona}
...
\palabrasclave{Detecci\'on de efectos del grog, C\'omputo vestible, Se\~nales fisiol\'ogicas}
...
\keywords{Grog's effect detection, Wearable computing, Physiological signals}
